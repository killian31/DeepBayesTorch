...
def run_script_with_args(script_path, model_names, attack_names, data_name, path_data, epsilons, save=False):
    """
    ...
    for m in model_names:
        for a in attack_names:
            command = ["python", script_path, "-M", str(m), "-A", str(a), "--path_data", str(path_data), '--data_name', str(data_name), "--epsilons"]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run a Python script with varying arguments.")
    ...
    parser.add_argument("-attack_names",
                        "-A",
                        type=str,
                        nargs="+",
    ...
    run_script_with_args(args.script_to_run,
